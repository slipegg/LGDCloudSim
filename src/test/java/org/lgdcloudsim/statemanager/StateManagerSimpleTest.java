...
public class StateManagerSimpleTest {
    ...
    void testStateManagerSimple() {
        ...
        statesManager.initHostStates(10, 10, 10, 10, 10, "Nvidia A100", 0, 20);
        HostState nowHostState0 = statesManager.getActualHostState(0);
        HostState exceptedHostState0 = new HostState(10, 10, 10, 10, 10, "Nvidia A100");
        assertEquals(exceptedHostState0, nowHostState0);

        Instance instance0 = new InstanceSimple(0, 2, 2, 2, 2, 2, "Nvidia A100");
        statesManager.allocate(0, instance0);
        HostState nowHostState1 = statesManager.getActualHostState(0);
        HostState exceptedHostState1 = new HostState(8, 8, 8, 8, 8, "Nvidia A100");
        ...
        HostState exceptedHostState2 = new HostState(10, 10, 10, 10, 10, "Nvidia A100");
