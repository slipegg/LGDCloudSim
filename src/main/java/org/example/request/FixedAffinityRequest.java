...
/**
 * Here is an example on how to generate fixed affinity requests from a file.
 * See "./src/main/resources/example/Request/FixedAffinityRequest.csv".
 *
 * @author Anonymous
 * @since LGDCloudSim 1.0
 */
public class FixedAffinityRequest {
    private static final String USER_REQUEST_FILE = "./src/main/resources/example/Request/FixedAffinityRequest.csv";
    ...
    public static void main(String[] args) {
        new FixedAffinityRequest();
    }

    private FixedAffinityRequest() {
