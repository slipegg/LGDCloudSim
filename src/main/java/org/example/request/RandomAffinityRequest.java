...
/**
 * Here is an example on how to generate random affinity requests from a file.
 * See "./src/main/resources/example/Request/RandomAffinityRequest.csv".
 *
 * @author Anonymous
 * @since LGDCloudSim 1.0
 */
public class RandomAffinityRequest {
    private static final String USER_REQUEST_FILE = "./src/main/resources/example/Request/RandomAffinityRequest.csv";
    ...
    public static void main(String[] args) {
        new RandomAffinityRequest();
    }

    private RandomAffinityRequest() {
