...
/**
 * Here is an example on how to generate random ordinary requests from a file.
 * See "./src/main/resources/example/Request/RandomOrdinaryRequest.csv".
 *
 * @author Anonymous
 * @since LGDCloudSim 1.0
 */
public class RandomOrdinaryRequest {
    private static final String USER_REQUEST_FILE = "./src/main/resources/example/Request/RandomOrdinaryRequest.csv";
    ...
    public static void main(String[] args) {
        new RandomOrdinaryRequest();
    }

    private RandomOrdinaryRequest() {
