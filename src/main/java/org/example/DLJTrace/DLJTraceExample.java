...
public class DLJTraceExample {
    ...
    private static final String DATACENTER_BW_FILE = "./src/main/resources/example/DLJTrace/DatacenterBwConfig.csv";
    ...
    private static final String HOST_TOPO_FILE = "./src/main/resources/example/DLJTrace/HostTopoConfig.csv";
