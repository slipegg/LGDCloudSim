...
public class CloudSimTag {
     ...
     * When such a {@link org.cpnsim.core.events.SimEvent} is sent, the {@link org.cpnsim.core.events.SimEvent#getData()}
     * must be a {@link org.cpnsim.datacenter.Datacenter} object.
     */
     ...
     * This tag is used by the {@link org.cpnsim.datacenter.Datacenter}.
     * the {@link org.cpnsim.core.events.SimEvent#getData()} must be a list of {@link org.cpnsim.request.Instance} objects
     ...
     * The {@link org.cpnsim.core.events.SimEvent#getData()} must be a set of {@link org.cpnsim.request.UserRequest} object.
     */
    public static final int USER_REQUEST_FAIL = BASE - 1;

    /**
     * Denotes a request from the {@link org.cpnsim.user.UserSimple} to a {@link CloudInformationService} to get
    ...
    /**
     * Denotes a request from the {@link org.cpnsim.user.UserSimple} to send.
     * It can be sent to the {@link CloudInformationService} or to a {@link org.cpnsim.datacenter.Datacenter}.
     * The {@link org.cpnsim.core.events.SimEvent#getData()} must be a list of {@link org.cpnsim.request.UserRequest} object.
     * It also can be the {@link org.cpnsim.interscheduler.InterScheduler} scheduling result.
     * In this case, the instanceGroups can be forwarded to other data centers.
     */
    public static final int USER_REQUEST_SEND = BASE + 3;

    /**
     * Denotes that there are still user requests that need to be sent by the {@link org.cpnsim.user.UserSimple}.
     */
     ...
     * The {@link org.cpnsim.core.events.SimEvent#getData()} must be a list of {@link InterSchedulerResult} object.
     */
    public static final int INTER_SCHEDULE_END = INTER_SCHEDULE_BEGIN + 1;

    /**
     * Send the scheduling results of the {@link org.cpnsim.interscheduler.InterScheduler} to the data center.
     ...
     * The {@link org.cpnsim.core.events.SimEvent#getData()} must be a list of {@link org.cpnsim.request.InstanceGroup} object.
     */
     ...
     * The {@link org.cpnsim.core.events.SimEvent#getData()} must be a {@link org.cpnsim.datacenter.FailedOutdatedResult< InstanceGroup >} object.
     */
     ...
     * It is used by the {@link org.cpnsim.datacenter.Datacenter}.
     * It will call the {@link org.cpnsim.datacenter.LoadBalance} to distribute the instances to the intra-schedulers.
     */
    public static final int LOAD_BALANCE_SEND = SCHEDULE_TO_DC_HOST_CONFLICTED + 1;

    /**
     * Denotes the end of the {@link org.cpnsim.intrascheduler.IntraScheduler} scheduling.
    ...
    /**
     * Denotes the start of the {@link org.cpnsim.intrascheduler.IntraScheduler} scheduling.
     */
